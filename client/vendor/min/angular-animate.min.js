            ...
            function (a) {
                ...
                this.$get = ["$$rAF", "$rootScope", "$rootElement", "$document", "$$HashMap", "$$animation", "$$AnimateRunner", "$templateRequest", "$$jqLite", function (d, s, n, g, l, D, z, Z, I) {
                    ...
                    function r(a, S, p) {
                        ...
                        if (g)return k(), m;
                        M && K(a);
                        g = {structural: M, element: a, event: S, close: k, options: p, runner: m};
                        if (l) {
                            if (b("skip", a, g, e)) {
                            ...
                            if (b("cancel", a, g, e))2 === e.state ? e.runner.end() : e.structural ? e.close() : R(a, g.options, e.options); else if (b("join", a, g, e))if (2 === e.state)R(a, p, {}); else return S = g.event = e.event, p = R(a,
                ...
                return function (w, B, r) {
                        ...
                        u(a, function (a, f) {
                            ...
                            if (d.length) {
                                ...
                                u(d, function (a) {
                                    ...
                                    c[b] = c[b] || {};
                                    c[b][h] = {animationID: f, element: G(a)}
                                })
                            } else b.push(a)
                        });
                        var f = {}, d = {};
                    ...
                    function E(a, b) {
                        ...
                        for (var c = [], f = 0; f < a.length; f++) {
                            var d = a[f];
                            if ("ng-" !== d.substring(0, 3))for (var h = 0; h < b.length; h++)if (d === b[h]) {
                                c.push(d);
                                break
                            }
                        }
